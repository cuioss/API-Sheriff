 ...
 * <p>
 * {@link de.cuioss.sheriff.api.config.load.ConfigLoader} reads {@code gateway.yaml}
 ...
 * {@link de.cuioss.sheriff.api.config.load.EnvSecretResolver}, and binds the valid
 * trees to the immutable {@link de.cuioss.sheriff.api.config.model} records with
 * Jackson.
 * <p>
 ...
 * a single {@link de.cuioss.sheriff.api.config.load.ConfigLoadException}.
 * <p>
