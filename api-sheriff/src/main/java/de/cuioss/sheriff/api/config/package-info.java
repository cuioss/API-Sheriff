 ...
 * configuration model into the runtime-ready {@link de.cuioss.sheriff.api.config.model.RouteTable}:
 * the {@link de.cuioss.sheriff.api.config.RouteTableBuilder} that materializes the
 * effective per-route settings, and the {@link de.cuioss.sheriff.api.config.ConfigLogMessages}
 ...
 * the {@code de.cuioss.sheriff.api.quarkus} edge package (ADR-0005); nothing here
