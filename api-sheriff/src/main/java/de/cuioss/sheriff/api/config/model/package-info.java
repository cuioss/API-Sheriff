 ...
 * loader: {@code gateway.yaml} binds to {@link de.cuioss.sheriff.api.config.model.GatewayConfig}
 * and each {@code endpoints/*.yaml} file binds to
 * {@link de.cuioss.sheriff.api.config.model.EndpointConfig}. Configuration is
