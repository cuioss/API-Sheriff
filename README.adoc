...
xref:benchmark-integration/doc/performance-scoring.adoc[Understand Performance Metrics]
...
The unified Quarkus application module containing the core library and CDI producers.

=== Integration Tests

End-to-end integration tests with native container testing and HTTPS support.
