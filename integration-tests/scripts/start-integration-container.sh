...
# the host target dir so uid 1001 can write quarkus.log there (ephemeral test output —
# not a security boundary; the container keeps its no-new-privileges / cap_drop posture).
