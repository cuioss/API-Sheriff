-- proxied_static_check.lua
-- WRK Lua script for benchmarking the proxied static backend (gateway -> nginx)
-- Sends GET requests through the /proxy route and validates 200 responses
