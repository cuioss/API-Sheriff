...
Node is *not* a prerequisite -- the `e2e-demo` profile downloads a pinned toolchain into `target/`.

== Running It

One command does everything -- toolchain install, lint, three-container bring-up, both Playwright
projects, teardown:
