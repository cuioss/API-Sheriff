...
image pulled by tag, all configuration supplied through read-only mounts, and every runtime-hardening
directive a real deployment should set, set explicitly rather than left to a default. It is a
