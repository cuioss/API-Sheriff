...
seven instances: the service set, each instance's published management port, and the scheme its
...
service name -- which is what lets one loop cover all seven instances.
