...
diagram back against both themes before committing any further edit to it, per the
link:diagram-type-deployment.md[deployment diagram-type standard]. Rendered PNGs remain verification
artifacts and are never committed.
