...
three egress client-construction sites, and `egress_tls.upstream_tls_profile` binds trust anchors
through a fail-closed resolver that refuses an unbound, trust-all or anchor-free profile at boot. The
