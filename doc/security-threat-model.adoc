...
*Scope limit (recorded, not a residual risk).* `egress_tls` governs the three Vert.x egress clients
and does not reach the *asset-origin* fetch, which is a fourth terminated-egress TLS leg: an asset
