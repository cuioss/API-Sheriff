...
*assert-behaviour-not-flag* discipline are not yet pinned as explicit assertions (see Gaps).
...
| <<gw-06>> | Fail-closed SNI/mTLS; test behaviour not flag | ADR-0017 (front listener) | PARTIAL
