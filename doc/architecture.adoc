...
validation, the route matcher, the authentication layer, and the zero-trust forward policy each
act in turn; a request that fails any stage is rejected before it reaches the upstream. The event
