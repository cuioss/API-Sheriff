= API Sheriff -- FAPI 2.0 Conformance Status (0.2.1 Alpha)
:toc: left
:toclevels: 3
:sectnums:
:sectnumlevels: 2
...
*FAPI 2.0 Security Profile (Final)* as of the 0.2.1 alpha release. It exists because the profile is
...
[IMPORTANT]
====
*Verdict: API Sheriff 0.2.1 is NOT FAPI 2.0 conformant.* Three of the profile's mandatory client
