...
*FAPI 2.0 Security Profile (Final)* as of the 0.2.2 alpha release. It exists because the profile is
...
[IMPORTANT]
====
*Verdict: API Sheriff 0.2.2 is NOT FAPI 2.0 conformant.* Three of the profile's mandatory client
