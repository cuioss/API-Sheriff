// ARCHIVED 2026-09-22 by the api-sheriff-0-2-0 orchestrator, from doc/plan/01-base-implementation.adoc.
//
// Provenance: one of three files that survived PLAN-V02-03's doc/plan/ retirement (9 of 12 deleted,
// 2026-08-09, PR #197) because no landing record in the corpus covered the TokenSheriff-scaffolding
// -to-verified-foundation work this file was the only account of. PLAN-V02-03's landing explicitly
// kept it for that reason ("not superseded, expected").
//
// This archive is what supersedes it now: full git history of the original file is preserved (see
// `git log --follow -- doc/plan/01-base-implementation.adoc` before this archival), and this copy is
// the durable record going forward. Retired from doc/ by PLAN-V02-18-retire-doc-plan-survivors.md,
// on explicit operator instruction 2026-09-22 overriding PLAN-V02-03's ruling — see that landing's
// residue and PLAN-V02-18's Objective for the reasoning.
//
...
(Plan 04 keeps the edge, replaces the internals):
